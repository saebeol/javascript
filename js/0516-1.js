...
localFunc();
// console.log("함수밖에서" + msg);  // msg defined
// 지역변수는 함수내에서만 사용할 수 있다.

var msg="hi everyone";  // 전역변수
function localFunc(){
    var msg="welcome";  // 전역변수값이 정의
    console.log("함수내에서" + msg);
}
localFunc();
...
myFunc1();
// 함수선언하면 초기 모든 함수들을 콜스택영역이라는곳에
// 모아서 생성된다.

// Stack Overflow발생
// 재귀함수
// 자기가 호출하면 stack overflow
