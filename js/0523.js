...
var num=15;
num.toString(); // 모든객체는 toString()할 수 있다.
console.log(num);
...
console.log(isNaN("welcome")); // true
...
console.log(str);
console.log(str.substr(2,5)); // 2개부터 시작
console.log(str);
...
// 금칙어를 조회
if(str.indexOf("성인")>-1){ // 0 -> flase  null NaN undefined
    console.log("금칙어가 있다");
...
// splide(n,m) 특정요소 지움
var 과일=["사과","배","귤","딸기","바나나"];
var fruit=['apple','strawberry','banana',"cherry"];
console.log(과일);
console.log(과일.splice(2,2)); // 귤, 딸기
console.log(과일); // 사과, 바나나, 배
...
console.log(result);
// 찾는값이 있으면 true로 반환하고 result에 저장한다.
