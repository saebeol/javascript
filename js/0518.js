...
// 키이름과 vlaue명이 같은경우에는 하나만 적어도 된다.
...
// 함수호출해야 call stack 사용가능한다.
// function 함수(){  } 으로 선언 -> 함수();
// 함수는 실행하고 끝나면 바로 메모리(스택)에서 제거된다.

// 함수를 생성한후 바로 곧바로 호출하기
// 익명함수를 사용한다

var add=(function(x,y){
    document.write("익명함수로 바로 후출하고 제거됨");
...
console.log(obj['+']);  // 키이름이 특수문자인경우 사용
console.log(obj['%']);
...
myCar.speed=100;
console.log(myCar.speed);
// 은닉화, 캡슐화, getter, setter 함수, 클로저가 필요하다.